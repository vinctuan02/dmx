...
<!-- <section id="header">
	<nav class="navbar bg-info" style="z-index: 9999">
		<div class="container">
                ...
                <div id="navbar" class="collapse navbar-collapse">
                	...
                	<ul class="nav navbar navbar-nav pull-right" id="nav2" >
                		...
                		if($this->session->userdata('sessionKhachHang')){
                			...
                			echo "<li><a href='#' style='padding: 2px;'><strong> $name</strong></a></li>";
                			echo "<li><a href='dang-xuat' style='padding: 2px; margin-left: 20px'>Logout</a></li>";
                		}else{
                			echo "<li  style='padding: 2px;'><a href='dang-ky'  style='padding: 2px;'>Đăng ký</a></li>";
                			echo "<li  style='padding: 2px;'><a href='dang-nhap'  style='padding: 2px; margin-left: 20px;'>Đăng nhập</a></li>";
                		}
                		?>
                	</ul>
                </div>
